    ...
    return(
        <section  className=" container grid gap-4 text-center sm:text-left">
          <div className="relative">
            <div className="hidden sm:block absolute w-8 bg-black -left-4 h-full"></div>
          <div className="ml-7">
          ...
          <div className="flex flex-wrap sm:flex-nowrap justify-center sm:justify-between items-center space-x-4 space-y-4">
            ...
            <div className="flex space-x-4">
              <button  className="grid place-items-center bg-green-600 hover:bg-green-600/90 rounded-full p-2 text-bkg focus:outline-none focus-visible:ring-4 ring-offset-2 ring-offset-bkg ring-accent disabled:bg-accent/20 disabled:text-accent" disabled>
              ...
              <button  className="grid place-items-center bg-green-600 hover:bg-green-600/90 rounded-full p-2 text-bkg focus:outline-none focus-visible:ring-4 ring-offset-2 ring-offset-bkg ring-accent disabled:bg-accent/20 disabled:text-accent">
