  ...
  return (
    <div className="  w-full h-full flex  flex-wrap justify-center items-center gap-4 pt-28 pb-14 bg-white">
      <div className="w-full flex justify-center items-center gap-3 my-20">
        ...
        />
        <h1 className=" text-5xl font-cinzelFont font-bold  text-farmer drop-shadow-2xl">
          Farmer Jack's
          <span className="pl-2 uppercase text-black">Forrestield</span>{" "}
        </h1>
      </div>
      {specials.map((special, index) => {
        return (
          <div
            key={index}
            className=" w-96 flex justify-center items-center rounded-2xl bg-gradient-to-r from-logoColor via-logoColor to-green-500 p-1"
          >
